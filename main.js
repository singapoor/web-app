...
}var fetchedData=vignanfile("data.json");
...
function education(edu){
    ...
    var tr="<tr> <th> Degree </td> <th> Institute </th> <th> Data </th></tr>";
tab.innerHTML=tr;
 var tr1="";
for(var i=0;i<edu.length; i++){
	tr1+="<tr> <td>"+edu[i].degree+"</td> <td>"+edu[i].instute+"</td> <td>"+edu[i].data+"</td></tr>";
}
